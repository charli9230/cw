...
<div id="bootstrap-touch-slider" class="carousel bs-slider fade  control-round indicators-line" data-ride="carousel" data-pause="hover" data-interval="5000" >
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="item active">
            ...
            <!-- Slide Background -->
            <img src="<?php echo base_url()?>assets/img/beach.jpg" alt="Bootstrap Touch Slider"  class="slide-image"/>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="slide-text slide_style_left">
                        <h1 data-animation="animated zoomInRight">COTWAY</h1>
        ...
        <div class="item">
            ...
            <div class="slide-text slide_style_center">
                <h1 data-animation="animated flipInX">COTWAY</h1>
        ...
        <div class="item">
            ...
            <div class="slide-text slide_style_right">
                <h1 data-animation="animated zoomInLeft">COTWAY</h1>
